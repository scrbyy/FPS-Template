...
public class OldInputProvider : MonoBehaviour, IWeaponInputProvider, IMovementInputProvider, ILookInputProvider, ILoadoutInputProvider, IInteractionInputProvider
{
    ...
    private void OnSprintStart(InputAction.CallbackContext ctx) => OnSprintPressed?.Invoke();
